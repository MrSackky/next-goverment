      ...
      <div className="bg-green-600 py-14" id="contact">
        <div className="mx-auto bg-white rounded w-3/4 lg:w-1/2">
          <div className="pt-4 pb-4 pr-4 pl-4">
            ...
            />
            <div style={{ margin: '24px 0' }} />
            <button className="uppercase lg:inline-flex lg:w-auto w-full px-3 py-2 rounded h-8 text-white bg-green-600 font-bold items-center justify-center hover:bg-green-300 hover:text-white">
              Register
            </button>
          </div>
        </div>
